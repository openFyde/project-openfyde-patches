...
CROS_WORKON_COMMIT="a50baeb85e6d627b2da889305e91e4f3f32eaf15"
CROS_WORKON_TREE=("2345346c6533c29d4e3ee84bc2bf53306247256c" "cad869bc783308ea338fa618a9495a68babb120b" "13c6a4ec079a88834780ccbd1597c8e59d479f90" "ba414ad0d84630d5bf4ac4f82bb576f80b0d5491" "1454f5ebf6a159645127c22d8c4e382e8752569d" "e7dba8c91c1f3257c34d4a7ffff0ea2537aeb6bb")
...
src_install() {
	...
	if use systemd; then
		...
		elif use tpm2_simulator && ! use vtpm_proxy; then
			newins ${FILESDIR}/init/lockbox-cache.conf.tpm2_simulator lockbox-cache.conf
		else
	...
	if use tpm_dynamic; then
		...
		newexe ${FILESDIR}/init/lockbox-cache.sh.tpm2_simulator lockbox-cache.sh
	else
