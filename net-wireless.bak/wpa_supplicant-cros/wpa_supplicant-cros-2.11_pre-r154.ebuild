...
EAPI=7
CROS_WORKON_COMMIT=("3ea363d457154d5570948fae627c6ede68ec29e4" "3ea363d457154d5570948fae627c6ede68ec29e4")
CROS_WORKON_TREE=("17593ca4e8d2ebe9e0149bb25cdc00c7f37bb2f5" "17593ca4e8d2ebe9e0149bb25cdc00c7f37bb2f5")
...
SLOT="0"
KEYWORDS="*"
IUSE="+ap bindist dbus debug eap-sim fuzzer +hs2-0 libressl +mbo mesh +p2p ps3 qt5 readline +seccomp selinux smartcard supplicant-next systemd tdls uncommon-eap-types +wep wifi_hostap_test +wnm wps kernel_linux kernel_FreeBSD wimax fils"
...
src_configure() {
	...
	append-flags -Werror
	append-lfs-flags
	# enable ChromeOS-specific code in wpa_supplicant
	append-cppflags "-DCHROMIUM"
